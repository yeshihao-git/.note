...
:PROPERTIES:
:ID:       4921b8ab-9885-4ad7-982c-0c892a9ab539
:END:

📎 [[https://dev.to/scarktt/installing-doom-emacs-on-windows-23ja][Installing Doom Emacs on Windows]]


*** 安装前置要求
- git
- [[https://github.com/BurntSushi/ripgrep/releases][ripgrep]]：安装 windows-gnu版本
- [[https://github.com/sharkdp/fd/releases][fd]]：安装 windows-gnu版本
