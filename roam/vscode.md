...
1. **同步配置**：`Ctrl+Shift+p` 打开命令面板，选择以下内容即可同步
![[Pasted image 20260618190605.png]]
同步过程可在 输出 面板查看
![[Pasted image 20260618190704.png]]

2. **查看同步历史**：`Ctrl+Shift+p` 打开命令面板，选择以下内容即可查看
![[Pasted image 20260618190756.png|191]]
同步历史如图所示，可以点开查看具体文件
![[Pasted image 20260618190952.png|298]]
...
下载低版本 `vscode`，以 `arch` 为例，在 https://code.visualstudio.com/updates/v1_98 中选择 `tarball（arch linux）` 下载

**why**：
远程服务器的 `GLIBC` 版本过低，新版 `vscode` `GLIBC` 版本较高
