...
# wget https://mirrors.huaweicloud.com/kunpeng/archive/compiler/bisheng_jdk/bisheng-jdk-21.0.9-b11-linux-x64.tar.gz 解压后放入 /usr/local
# echo 'export JAVA_HOME=/usr/local/bisheng-jdk-21.0.9' >> ~/.bashrc
